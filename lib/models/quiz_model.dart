...
class QuizModel {
  ...
  final String quizId; // The unique ID generated by Firebase for this quiz document.
  ...
  final String createdBy; // The User ID (UID) of the teacher who created this quiz.
  ...
  final int totalQuestions; // The target number of questions this quiz should have.
  final int marksPerQuestion; // How many marks a student gets for one correct answer.
  ...
  factory QuizModel.empty() {
    return QuizModel(
      ...
      status: 'draft', // New quizzes always start as drafts to prevent accidental publishing.
    );
  }
