  ...
  Future<void> _addQuestion() async {
    ...
    try {
      ...
      final newQuestion = QuestionModel(
        questionId: '', // Will be set by Firestore (ID is autogenerated at the document level).
        questionText: _questionController.text.trim(),
        options: options,
        correctAnswerIndex: _correctAnswerIndex!, // The correct answer index (0, 1, 2, or 3) is saved.
      );
        ...
        child: Column(
          ...
          children: [
            ...
            AppButton(
              ...
              onPressed: _isAdding ? null : _addQuestion, // Disables button when loading.
              isLoading: _isAdding,
            ),
          ],
        ),
  ...
  Widget _buildOptionField(BuildContext context, TextEditingController controller,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Radio<int>(
            value: index, // What it is doing: The unique index (0-3) for this option.
