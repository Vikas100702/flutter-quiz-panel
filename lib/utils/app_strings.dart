...
class AppStrings {
  ...
  static const String passwordMinLength = 'Password must be at least 6 characters.'; // Used for input hints/validation.
  ...
  static const String resendEmailCooldown = 'You can resend in %s seconds'; // %s is a placeholder for the countdown timer.
  ...
  static const String userDataNotFound = 'No user data found in database. Please contact support.'; // Critical error for AuthWrapper.
